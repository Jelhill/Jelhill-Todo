...
function passwordProtected(req, res, next) {
  ...
  if (req.headers.authorization == "Basic b2xhYmlzaTp1bWFydQ==") {
    next();
  }else{
...
//Connect to Database
const connectionString = "mongodb+srv://jelhill:pass@cluster0-dfckv.mongodb.net/todoApp?retryWrites=true&w=majority";
let db
